...
[`validation/pi05_smoke.json`](validation/pi05_smoke.json) records three real
...
all 51 backbone parameter leaves; only 119 new context leaves were initialized.
The no-context/native float32 maximum action difference was
`3.4e-06`. The same comparison in
bfloat16 had maximum difference `0.03484`;
